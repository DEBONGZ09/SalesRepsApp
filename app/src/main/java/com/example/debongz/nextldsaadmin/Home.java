...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reptxt = (TextView)findViewById(R.id.rephometxt);
        CreateOrder = (FloatingActionButton) findViewById(R.id.add_new_order);
        loadiquotes = (ProgressBar)findViewById(R.id.load_quote);
        ...
        CreateOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Home.this, ShopDetails.class);
    ...
    public void more(View view) {
        Intent intent = new Intent(Home.this, OrderStages.class);
        startActivity(intent);
    }
    ...
    private class AsyncFetcha extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                zmycustRecycleViewa = (RecyclerView) findViewById(R.id.list_quotes);
                zmAdaptera = new AdapterQuotes(Home.this, data);
                zmycustRecycleViewa.setAdapter(zmAdaptera);
                zmycustRecycleViewa.setLayoutManager(new LinearLayoutManager(Home.this));
